...
#python freq_ic.py -f GalOscillation_Time_2024_01_05-2024_01_26_Freq_70-150.npz -ini 2024-01-05 -fin 2024-01-09
...
class fit_data:
    ...
    def plot_pol(self, ax, ant_i, chan_i, color_map):
        id_i = f'{ant_i+1}{chan_i}'
        ...
        ax.plot(x_interpolated, y_interpolated, lw=4.5, label=f'Fit rms Ant. {ant_i+1}, Ch. {chan_i+1}', c=color_map[ant_i])
        ax.errorbar(x_interpolated, y_interpolated, yerr=sem, markersize=3.0, fmt ='o', ecolor=color_map[ant_i], markeredgecolor=color_map[ant_i], markerfacecolor=color_map[ant_i])
    ...
    def plot_rms(self):
        ...
        color_map = cmap(np.linspace(0.2, 0.8, self.ant))
        ...
        for chan_i in range(self.pol):
            ...
            for ant_i in range(self.ant):
                self.plot_pol(ax, ant_i, chan_i, color_map)
