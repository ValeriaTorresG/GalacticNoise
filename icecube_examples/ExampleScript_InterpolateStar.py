...
#Run as: python ExampleScript_InterpolateStar.py /data/sim/IceCubeUpgrade/CosmicRay/Radio/coreas/data/continuous/star-pattern/proton/lgE_16.5/sin2_0.7/000000
...
tray.AddModule(radcube.modules.SimulateFromStar, "SimulateFromStar",
               ...
               NThrows = 100,                       #How many Q-frames to make per CoREAS file
